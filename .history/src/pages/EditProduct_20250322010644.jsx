...
const EditProduct = () => {
    ...
    const getProductDetails = () => {
        axios
            .get(`${BASE_URL}/products/${id}`) // Fetch product by ID
            .then((response) => {
    ...
    const handleChange = (event) => {
        ...
        setFormData((prevData) => ({
            ...prevData,
            [name]: type === "file" ? files[0] : value.trim(), // Trim spaces for cleaner data
        }));
    };
    ...
    const updateProduct = (e) => {
        ...
        // Ensure formData is updated before using it
        setTimeout(() => {
            Object.entries(formData).forEach(([key, value]) => {
                if (value !== null && value !== undefined) {
                    data.append(key, value instanceof File ? value : String(value)); // Convert numbers to string
                }
            });
        ...
        }, 100); // Delay ensures latest state update
    };
                            ...
                            <form onSubmit={updateProduct}>
                                <div className="row">
                                    ...
                                    <div className="col-lg-12 col-sm-12 col-md-12 mt-3 form-group mt-5 mb-3">
                                        <img style={{ height: '200px', width: '200px' }} src={`${IMAGE_URL}/admin/product/${formData.product_image}`} alt="" />
                                    </div>
