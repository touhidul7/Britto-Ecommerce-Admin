...
const EditProduct = () => {
    ...
    const updateProduct = (e) => {
        ...
        // Check if the formData contains valid data
        console.log("Form Data before appending to FormData:", formData);

        for (const [key, value] of Object.entries(formData)) {
            if (value !== null && value !== undefined) {
                // Check if value is a file (product_image) or normal input
                if (value instanceof File) {
                    console.log(`Appending file: ${key} ->`, value);
                    data.append(key, value); // Append the file object
                } else {
                    console.log(`Appending field: ${key} ->`, value);
                    data.append(key, value); // Append normal input field values
                }
            }
        }
        ...
        axios.put(`${BASE_URL}/product/update/${id}`, data, {
