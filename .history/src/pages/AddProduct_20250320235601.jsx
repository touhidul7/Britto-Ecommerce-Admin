...
const AddProduct = () => {
    ...
    const submit = (e) => {
        ...
        let product_image = e.target[6].files[0]; // Get the file from input
        axios
            .post(`${BASE_URL}/product/add`, {
                product_name, select_category, availability, regular_price, selling_price, product_description, product_image, headers: {
