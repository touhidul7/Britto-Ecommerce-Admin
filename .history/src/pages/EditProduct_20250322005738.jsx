                        ...
                        <div className="card-body">
                            <form onSubmit={updateProduct}>
                                <div className="row">
                                    ...
                                    <div className="col-lg-12 col-sm-12 col-md-12 mt-3 form-group my-5">
                                    <img style={{ height: '250px',width:'250px' }} src={`${IMAGE_URL}/admin/product/${formData.product_image}`} alt="" />
                                    </div>
